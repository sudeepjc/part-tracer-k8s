...
joinChannel() {
	...
	cat log.txt
	echo
	verifyResult $res "After $MAX_RETRY attempts, General Org has failed to join channel '$CHANNEL_NAME' "
}
...
updateAnchorPeers() {
	...
	echo "===================== Anchor peers updated for org 'General' on channel '$CHANNEL_NAME' ===================== "
	sleep $DELAY
	echo
}
...
echo
echo "========= 'General' Org successfully joined ${CHANNEL_NAME} =========== "
echo
